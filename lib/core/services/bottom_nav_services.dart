...
final navigatorKeysProvider = Provider<Map<String, GlobalKey<NavigatorState>>>((ref) {
  return {
    ...
    Routes.profile: GlobalKey<NavigatorState>(),
    Routes.buddies: GlobalKey<NavigatorState>(),
    Routes.discover: GlobalKey<NavigatorState>(),
    Routes.setting: GlobalKey<NavigatorState>(),
  };
});
